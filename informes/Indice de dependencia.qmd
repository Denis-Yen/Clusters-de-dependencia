...
## 2. Construcción de perfile distritales según indicadores de dependencia demográfica
...
## 7. Proceso del análisis del método de *K-means clustering*
...
![MIMP - Dirección de Población](images/Grafico%203-01.png){fig-align="center"}
...
![MIMP - Dirección de Población](images/Grafico 4-06.png){fig-align="center"}

## Sintaxis en R

Puede acceder al script de **R** utilizado para replicar el análisis de clústeres en el siguiente repositorio: [Script completo de K-means](https://github.com/Denis-Yen/Clusters-de-dependencia/blob/master/scripts/k_means_completo_fe.R)
...
![](images/map_nive_dist_clus.png){fig-align="center"}
